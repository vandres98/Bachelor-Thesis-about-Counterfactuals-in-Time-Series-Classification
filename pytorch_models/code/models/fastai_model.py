from pytorch_models.code.models.timeseries_utils import *
...
from pytorch_models.code.models.resnet1d import resnet1d18,resnet1d34,resnet1d50,resnet1d101,resnet1d152,resnet1d_wang,resnet1d,wrn1d_22
from pytorch_models.code.models.xresnet1d import xresnet1d18,xresnet1d34,xresnet1d50,xresnet1d101,xresnet1d152,xresnet1d18_deep,xresnet1d34_deep,xresnet1d50_deep,xresnet1d18_deeper,xresnet1d34_deeper,xresnet1d50_deeper
from pytorch_models.code.models.inception1d import inception1d
from pytorch_models.code.models.basic_conv1d import fcn,fcn_wang,schirrmeister,sen,basic1d,weight_init
from pytorch_models.code.models.rnn1d import RNN1d
import math

from pytorch_models.code.models.base_model import ClassificationModel
import torch 
...
from pytorch_models.code.utils.utils import evaluate_experiment
...
class fastai_model(ClassificationModel):
    ...
    def fit(self, X_train, y_train, X_val, y_val):
        ...
        if(self.pretrainedfolder is None): #from scratch
            ...
            output_layer_new = nn.Linear(output_layer.in_features,self.num_classes)
